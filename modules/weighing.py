...
class Thread(threading.Thread):
    def __init__(self,port,masses,mass_positions,reads_per_mass,centerings,parent,run_option,num_cycles,simulated=False):
        ...
        if not simulated: #set some constants, they dont exist in simulated visa yet.
            self.balance.baud_rate = 2400
            self.balance.parity = self.visa.constants.Parity.even
            self.balance.stop_bits = self.visa.constants.StopBits.one
